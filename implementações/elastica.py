...
canvas(align="center", width=700, height=400, title = "<h1>Simulação 3D de Sistema Massa-Mola</h1>")
...
superficie = box(pos=vec(mola.length / 2, -bloco.height / 2 - .25, 0), size=vec(L + 10, .5, 4), texture = textures.metal)
